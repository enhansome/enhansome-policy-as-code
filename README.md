# Awesome Policy-as-Code with stars
...
* [Managing Azure Policy as Code with GitHub](https://github.com/Azure/manage-azure-policy/blob/main/tutorial/azure-policy-as-code.md) ⚠️ Archived
...
* [OPA](https://github.com/open-policy-agent/opa) ⭐ 12,191 | 🐛 333 | 🌐 Go | 📅 2026-09-03 - An open source, general-purpose policy engine that enables unified, context-aware policy enforcement across the entire stack

* [Checkov](https://github.com/bridgecrewio/checkov) ⭐ 8,977 | 🐛 168 | 🌐 Python | 📅 2026-09-01 - A static code analysis tool for infrastructure-as-code

* [Kyverno](https://github.com/kyverno/kyverno) ⭐ 8,101 | 🐛 661 | 🌐 Go | 📅 2026-09-03 - A policy engine designed for Kubernetes. It can validate, mutate, and generate configurations using admission controls and background scans

* [Cloud Custodian](https://github.com/cloud-custodian/cloud-custodian) ⭐ 6,060 | 🐛 1,737 | 🌐 Python | 📅 2026-09-03 - Rules engine for cloud security, cost optimization, and governance, DSL in yaml for policies to query, filter, and take actions on resources
...
* [Gatekeeper](https://github.com/open-policy-agent/gatekeeper) ⭐ 4,275 | 🐛 192 | 🌐 Go | 📅 2026-09-02 - Policy Controller for Kubernetes

* [kics](https://github.com/Checkmarx/kics) ⭐ 2,699 | 🐛 316 | 🌐 Open Policy Agent | 📅 2026-09-03 - Find security vulnerabilities, compliance issues, and infrastructure misconfigurations earlier
...
* [Konstraint](https://github.com/plexsystems/konstraint) ⭐ 393 | 🐛 22 | 🌐 Go | 📅 2025-11-20 - A policy management tool for interacting with Gatekeeper

* [Gatekeeper Policy Manager (GPM)](https://github.com/sighupio/gatekeeper-policy-manager) ⭐ 328 | 🐛 5 | 🌐 Go | 📅 2026-09-02- A simple to use web-based Gatekeeper policies manager

* [kube-mgmt](https://github.com/open-policy-agent/kube-mgmt) ⭐ 261 | 🐛 13 | 🌐 Go | 📅 2026-08-27 - Sidecar for managing OPA on top of Kubernetes

* [Fregot](https://github.com/fugue/Fregot) ⭐ 231 | 🐛 10 | 🌐 Haskell | 📅 2022-06-30 - A set of tools for working with the Rego policy language, which is part of the Open Policy Agent (OPA) policy engine
