...
* [OPA](https://github.com/open-policy-agent/opa) ⭐ 12,259 | 🐛 304 | 🌐 Go | 📅 2026-09-22 - An open source, general-purpose policy engine that enables unified, context-aware policy enforcement across the entire stack

* [Checkov](https://github.com/bridgecrewio/checkov) ⭐ 9,021 | 🐛 173 | 🌐 Python | 📅 2026-09-17 - A static code analysis tool for infrastructure-as-code

* [Kyverno](https://github.com/kyverno/kyverno) ⭐ 8,174 | 🐛 759 | 🌐 Go | 📅 2026-09-22 - A policy engine designed for Kubernetes. It can validate, mutate, and generate configurations using admission controls and background scans

* [Cloud Custodian](https://github.com/cloud-custodian/cloud-custodian) ⭐ 6,068 | 🐛 1,751 | 🌐 Python | 📅 2026-09-17 - Rules engine for cloud security, cost optimization, and governance, DSL in yaml for policies to query, filter, and take actions on resources
...
* [Gatekeeper](https://github.com/open-policy-agent/gatekeeper) ⭐ 4,277 | 🐛 197 | 🌐 Go | 📅 2026-09-21 - Policy Controller for Kubernetes

* [kics](https://github.com/Checkmarx/kics) ⭐ 2,704 | 🐛 312 | 🌐 Open Policy Agent | 📅 2026-09-22 - Find security vulnerabilities, compliance issues, and infrastructure misconfigurations earlier
...
* [Gatekeeper Policy Manager (GPM)](https://github.com/sighupio/gatekeeper-policy-manager) ⭐ 328 | 🐛 2 | 🌐 Go | 📅 2026-09-16- A simple to use web-based Gatekeeper policies manager

* [kube-mgmt](https://github.com/open-policy-agent/kube-mgmt) ⭐ 261 | 🐛 15 | 🌐 Go | 📅 2026-09-18 - Sidecar for managing OPA on top of Kubernetes
...
* [OPAL](https://github.com/authorizon/opal) ⭐ 97 | 🐛 1 | 🌐 Python | 📅 2024-08-12 - Policy and data administration, distribution, and real-time updates on top of Open Policy Agent
